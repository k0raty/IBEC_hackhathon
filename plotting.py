...
def plot_results(scores, codes, exploration_iterations, proposal_graphs, response_graphs):
    # Plot the overall score evolution and codes found at each iteration
    ...
    # Annotate the codes found at each iteration
    for i, code in enumerate(codes):
        plt.annotate(code, (i + 1, scores[i]), textcoords="offset points", xytext=(0, 5), ha='center')
